...
const TeacherCalendar = ({ theme, showCalendar, setShowCalendar, userName, userEmail }) => {
  ...
  const fetchData = async (date) => {
    try {
      ...
      const response = await axios.get(`http://127.0.0.1:8000/api/getSchedulesByTeacherEmailAndDate/${userEmail}/${dateString}`);
