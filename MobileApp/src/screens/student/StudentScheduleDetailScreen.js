...
const ScheduleDetailScreen = ({ route }) => {
  const { course_name, destination, clazz_code, start_time, end_time, userName, userEmail, course_code, clazz_date, teacher_name } = route.params;
    ...
    <ScrollView style={styles.container}>
      ...
      <Card style={[styles.card, { backgroundColor: theme.colors.surface }]}>
        ...
        <Card.Content>
          ...
          <Text style={[styles.detailText, { color: theme.colors.text }]}>
            <Text style={styles.detailLabel}>Giáo viên:</Text> {teacher_name}
          </Text>
          <Text style={[styles.detailText, { color: theme.colors.text }]}>
