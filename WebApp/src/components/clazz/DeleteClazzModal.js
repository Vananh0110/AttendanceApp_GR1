...
const DeleteClazzModal = ({ fetchClazzes, visible, clazz, onCancel, onDeleteSuccess }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.delete(`http://127.0.0.1:8000/api/clazzes/${clazz.id}`); // Điều chỉnh endpoint API tương ứng
...
export default DeleteClazzModal;